...
export const WEAPON_PEN_1 = 10;
export const WEAPON_PEN_1_MINUS = 5;
export const WEAPON_PEN_2 = 20;
export const WEAPON_PEN_2_MINUS = 12;
...
export const MODDERS_2_MULTI = 0.2;
